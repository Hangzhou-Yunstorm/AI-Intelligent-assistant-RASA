    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        $.each(this.options.columns, function (i, columns) {
            ...
            $.each(columns, function (j, column) {
                ...
                html.push(sprintf('<div class="th-inner %s" style="width:' + width + 'px">', that.options.sortable && column.sortable ?
                    'sortable both' : ''));
                ...
                html.push(text);
                html.push('</div>');
                html.push('<div class="fht-cell" style="width:' + width + 'px"></div>');
                html.push('</div>');
                html.push('</th>');
            });
            html.push('</tr>');
