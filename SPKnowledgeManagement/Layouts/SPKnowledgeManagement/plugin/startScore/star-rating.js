    ...
    Rating.prototype = {
        ...
        init: function (options) {
            ...
            if (typeof self.$rating == 'undefined' && typeof self.$container == 'undefined') {
                self.$rating = $(document.createElement("div")).html('<div class="rating-stars" title=' + self.initialValue + '></div>');
        ...
        generateRating: function () {
            ...
            self.$rating.attr('title', self.initialValue);
